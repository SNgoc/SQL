CREATE DATABASE Exercise333
ON PRIMARY (NAME = 'Exercise333', FILENAME = 'N:\FPTAptech\SQL Data base\Exercise333.mdf', SIZE = 5MB, MAXSIZE = 50MB, FILEGROWTH = 10%),
FILEGROUP Group1
(NAME = 'FileGroup_Exercise333', FILENAME = 'N:\FPTAptech\SQL Data base\Exercise333.ndf', SIZE = 10MB, MAXSIZE = UNLIMITED, FILEGROWTH = 5%)
LOG ON (NAME = 'Exercise333_log', FILENAME = 'N:\FPTAptech\SQL Data base\Exercise333_Log.ldf', SIZE = 2MB, MAXSIZE = UNLIMITED, FILEGROWTH = 10%)
GO
...
ALTER TABLE dbo.Comment ADD CONSTRAINT FK_CustomerID FOREIGN KEY(CustomerID) REFERENCES dbo.Customer(CustomerID)
GO
...
--6.	Display the name of customers who have the most comments.
SELECT * FROM dbo.Customer
...
UPDATE dbo.Product SET ProductID = 1 WHERE ProductID = 6
