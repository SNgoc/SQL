-- 1/ Tạo DB + Sử dụng DB
	...
	ON PRIMARY (NAME = 'HowKteamSQL_S8', FILENAME = 'N:\FPTAptech\SQL Data base\HowKteamSQL_S8.mdf')
	LOG ON (NAME = 'HowKteamSQL_S8_Log', FILENAME = 'N:\FPTAptech\SQL Data base\HowKteamSQL_S8.ldf')
	GO
